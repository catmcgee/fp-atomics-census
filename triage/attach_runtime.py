...
ROWS: list[tuple[str, list[str], str]] = [
    ...
    (r"^vllm_qwen3_8b_bf16_tp2_custom_allreduce_x6$", ["vllm-0182"], "TP=2 with vLLM's custom all-reduce, 6 repeats"),
    (r"^vllm_qwen3_8b_bf16_tp2_nccl_x6$", ["vllm-0182"], "TP=2 with custom all-reduce disabled (NCCL), 6 repeats"),
