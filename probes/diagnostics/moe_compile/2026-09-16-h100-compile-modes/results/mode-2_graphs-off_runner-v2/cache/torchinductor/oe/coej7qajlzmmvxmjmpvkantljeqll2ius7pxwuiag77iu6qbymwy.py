...
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    r0_numel = 2048
    rnumel = r0_numel
...
def get_args():
    arg_0 = rand_strided((16384,), (1,), device='cuda:0', dtype=torch.int32)
    arg_1 = rand_strided((151936, 2048), (2048, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_2 = rand_strided((2048,), (1,), device='cuda:0', dtype=torch.bfloat16)
    arg_3 = rand_strided((16384, 2048), (2048, 1), device='cuda:0', dtype=torch.bfloat16)
    return arg_0, arg_1, arg_2, arg_3, 16384, 2048,
