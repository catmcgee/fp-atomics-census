...
def main() -> int:
    ...
    summary = {"experiment": "E2", "arm": arm_name(args), "env": environment(), "repeats": args.repeats,
    ...
    print(f"E2 {arm_name(args)}: P1 {summary['verdict_P1']}; steps {len(steps)}; distinct shape vectors {summary['distinct_step_shape_vectors']}; violations {len(violations)}")
    return 0
